/**
 * AI connection verification (bring-your-own-key). Sends the smallest
 * possible Anthropic Messages API request to confirm a key/model pair
 * actually works, so the settings panel can show "connected" before the
 * user relies on it inside a real report generation call.
 */
